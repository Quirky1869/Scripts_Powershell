...
$Params = @{
  Content = "Pour finaliser la procédure, il faut redemarrer le PC"
  Title = "Bientot Fini"
  TitleFontSize = 20
  CornerRadius = 25
  ...
  ButtonType = 'None'
  CustomButtons = "OK" , "Ne pas redemarrer"
  ContentTextForeground = 'Black'
  ButtonTextForeground = 'SteelBlue'
}

Remove-Item -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Print\Environments\Windows x64\Drivers\Version-3\TOSHIBA Universal Printer 2" -Recurse
