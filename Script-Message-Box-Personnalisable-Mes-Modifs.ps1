...
$Params = @{
    Content = "Pour finaliser l'installation, il faut fermer la session"
    Title = "Bientot Fini"
    TitleFontSize = 20
    CornerRadius = 25
    ...
    ButtonType = 'None'
    CustomButtons = "OK fermer la session" , "Ne pas fermer la session"
    ContentTextForeground = 'Black'
    ButtonTextForeground = "SteelBlue"
  }
New-WPFMessageBox @Params


If ($WPFMessageBoxOutput -eq "OK fermer la session")
{
   Write-Host "Fermeture session en cours"
