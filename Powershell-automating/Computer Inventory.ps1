...
$Printers = Get-CimInstance -ClassName:Cim_Printer | ? {$_.Network -EQ 'true'} | select Name, Caption| ConvertTo-Html -Fragment
...
<font color = blue><H4><B>Imprimantes</B></H4></font>$Printers
