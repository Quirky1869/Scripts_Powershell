...
function Call-AWSA_pff {
	...
	$cmsAdminAdd_Click={
		$Input = [Microsoft.VisualBasic.Interaction]::InputBox("Entrez un Nom d'utilisateur à ajouter (Domain\Username)", "Add Local Admin", "")
	...
	$btnMsg_Click={
		Get-ComputerName
		$Message = [Microsoft.VisualBasic.Interaction]::InputBox("Entrez un message à envoyer", "Envoyer un message à $ComputerName", "")
		If($Message -ne ''){
	...
	$btnRestart_Click={
		Get-ComputerName
		$VBRestart = $VBMsg.popup("Redémarrer ? " + $ComputerName.ToUpper() + "?",0,"Reboot " + $ComputerName.ToUpper() + "?",4)
		Switch ($VBRestart)
		{
	...
	$formMain.Text = "Alex System Administration v1.0"
	...
	$btnRA.Size = '110, 30'
	$btnRA.TabIndex = 9
	$btnRA.Text = "Assistance à Distance"
	...
	$btnStartupItems.Text = "Démarrage"
	...
	$btnLocalAdmins.Text = "Admins Locaux"
	...
	$btnSystemInfo.Text = "Infos Système"
	...
	$btnSearch.Text = "Rechercher un PC"
