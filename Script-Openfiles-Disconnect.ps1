...
[System.Reflection.Assembly]::LoadWithPartialName('Microsoft.VisualBasic')
    ...
    $TextBlock.Text = "Sélectionner le lecteur réseau voulu :"
    $TextBlock.Margin = 10
    ...
    {
    If ($Location -eq "Medical K:") {
    
        
        $chemin = [Microsoft.VisualBasic.Interaction]::InputBox("Veuillez saisir le chemin après K:\ avec l'extension du fichier :", "                                        Chemin".ToUpper(), "")

        openfiles /disconnect /s filer.adcha.local /o Read/write /op "c:\medical\qt_medical\$($chemin)"

        
    }

    Elseif ($Location -eq "Administration J:") {

    
        $chemin = [Microsoft.VisualBasic.Interaction]::InputBox("Veuillez saisir le chemin après J:\ avec l'extension du fichier :", "                                        Chemin".ToUpper(), "")

        openfiles /disconnect /s filer.adcha.local /o Read/write /op "c:\admin\qt_admin\$($chemin)"
        
    }

    Elseif ($Location -eq "Forum G:") {


        $chemin = [Microsoft.VisualBasic.Interaction]::InputBox("Veuillez saisir le chemin après G:\ avec l'extension du fichier :", "                                        Chemin".ToUpper(), "")

        openfiles /disconnect /s filer.adcha.local /o Read/write /op "c:\vol_forum\qt_forum\$($chemin)"
        
    }
    
    
     Elseif ($Location -eq "Apps I:") {


        $chemin = [Microsoft.VisualBasic.Interaction]::InputBox("Veuillez saisir le chemin après I:\ avec l'extension du fichier :", "                                        Chemin".ToUpper(), "")

        openfiles /disconnect /s filer.adcha.local /o Read/write /op "c:\Apps\$($chemin)"
