# By Micka
#=======================================Fermer fichier(s) ouvert(s) avec des Message Box===========================================================#
...
function error {
 ...
 $ParamsErreur = @{
    Content = "Entrez un chemin UNC svp"
    Title = "Erreur"
    TitleFontSize = 20
    CornerRadius = 15
    TitleBackground = 'Red'
...
# Paramétrages du Message Box
$Params = @{
    Content = "Quel lecteur reseau voulez vous ?"
    Title = "Lecteurs Reseau"
    TitleFontSize = 20
    CornerRadius = 15
    TitleBackground = 'MidnightBlue'
    TitleTextForeground = 'White'
    ButtonType = 'None'
    CustomButtons = "Medical$" , "Administration$" , "Forum$" , "Apps$"
    ContentTextForeground = 'Black'
...
If ($WPFMessageBoxOutput -eq "Medical$")
{
    $Message = [Microsoft.VisualBasic.Interaction]::InputBox("Entrez votre chemin", "Quel chemin UNC")
    If($Message -ne ''){

    Write-Host 'OK Medical' -ForegroundColor Green
...
ElseIf ($WPFMessageBoxOutput -eq "Administration$")
{
    
        $Message = [Microsoft.VisualBasic.Interaction]::InputBox("Entrez votre chemin", "Quel chemin UNC")
    If($Message -ne ''){
    
    Write-Host 'OK Administration' -ForegroundColor Green
