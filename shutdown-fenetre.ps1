...
Add-Type -AssemblyName PresentationFramework
		...
		$Array = @(
			...
			"Annuler le redemarrage ou l'arret"
			"Redemarrer"
			"Arreter"
		...
		$TextBlock.Text = "Voulez-vous programmer un arret ou un redemarrage de votre PC ?"
		$TextBlock.Margin = 10
		...
		If ($WPFMessageBoxOutput -eq "OK")
		{
                ...
                Elseif ($Location -eq "Annuler le redemarrage ou l'arret")
                {
